...
| `C:\dev\simplespeak-centerline-review` | Centerline tracing, stroke normalization, contact sheets, and visual review outputs | Asset-production review input; not runtime or specification authority |
