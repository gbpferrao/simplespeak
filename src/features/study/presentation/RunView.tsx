...
import { Check, CheckCircle2, ChevronRight, Compass, Eye, EyeOff, Keyboard, Layers3, Lightbulb, Map, Play, RotateCcw, ShieldCheck, SlidersHorizontal, Sparkles, Target, Timer, X } from 'lucide-react'
